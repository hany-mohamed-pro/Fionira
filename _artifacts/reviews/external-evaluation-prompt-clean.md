# حزمة التقييم الخارجي لنظام Fionira (النسخة المستقلة/النظيفة) — prompt جاهز للتسليم
> **تعليمات الاستخدام (لهاني):** انسخ هذا الملف كاملاً والصقه في جلسة النموذج/الخبير الخارجي كرسالة واحدة. كل شيء مضمَّن — لا يحتاج المُقيِّم أي وصول للمستودع. هذه النسخة بلا تقارير التدقيق الداخلية عمداً، لرأي مستقل غير مُوجَّه.
...
ملاحظة منهجية مهمة: لا توجد تقارير تقييم سابقة مرفقة — كل حكم
يجب أن يأتي من استكشافك المستقل للوثائق أدناه فقط. تعامل مع كل
ما تقرؤه كمُدخل قابل للنقد، واكتشف بنفسك ما لم يُوثَّق.
...
═══════════════════════════════════════
الوثائق المرفقة (4 وثائق كاملة أدناه)
═══════════════════════════════════════
