...
export default function App() {
  ...
  const renderContentHeader = () => {
    ...
    if (type === 'GLOBAL_DASHBOARD') {
       ...
       else if (activeTab === 'balance_sheet') { pageTitle = isRTL ? 'الميزانية العمومية' : 'Balance Sheet'; subtitle = isRTL ? 'الميزانية الحقيقية من القيود المحاسبية الفعلية — متوازنة بلا تقدير.' : 'Real balance sheet from actual journal entries — balanced, no estimate.'; }
       ...
       if (activeTab === 'smart_invoice') { pageTitle = isRTL ? 'الفاتورة الذكية' : 'Smart Invoice'; subtitle = isRTL ? 'إنشاء وإدارة الفواتير وتصديرها PDF.' : 'Create, manage, and export invoices as PDF.'; }
