...
export function processRevenues(buffer: ArrayBuffer, fileName: string) {
  ...
  const targetKeywords = [/خاضع/i, /taxable/i, /صافي/i, /net/i, /غيرخاضع/i, /nontaxable/i, /vat/i, /ضريب/i, /total/i, /اجمال/i, /فاتور/i, /inv/i, /date/i, /تاريخ/i, /عميل/i, /اسم/i, /customer/i, /desc/i, /بيان/i, /تفاصيل/i, /قيم/i, /مبلغ/i];
  ...
  const columnMapLock = {
      ...
      entity: getCol([/entity/i, /customer/i, /client/i, /عميل/i, /اسم/i, /name/i]),
  ...
  for (let i = headerRowIndex + 1; i < data.length; i++) {
    ...
    const category = "إيرادات المبيعات";
